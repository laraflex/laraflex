            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('password.request') }}" aria-label="{{ __('Reset Password') }}">
                        ...
                        <div class="form-group row">
                            <label for="password" class="col-10 col-md-4 col-form-label text-md-right">{{ __('Password') }}</label>
                        ...
                        <div class="form-group row">
                            <label for="password-confirm" class="col-10 col-md-4 col-form-label text-md-right">{{ __('Confirm Password') }}</label>
