...
<div class="modal fade" id="deleteModal" tabindex="-1" role="dialog" aria-labelledby="ModalLabel" aria-hidden="true">
    ...
    <h6 class="modal-title" id="ModalLabel">
        <img src="{{url('images/icons/users.png')}}" class="mr-2 ml-3" style="width:40px; height:40px;">
        {{$user->name}}</h6>
    @endif
    ...
    <button type="submit" class="btn btn-sm px-4 btn-light btn-outline-secondary mt-3" onclick="action='{{$route2}}';">
    {{ __('Confirm') }}
    </button>
    </div>
    </form>
